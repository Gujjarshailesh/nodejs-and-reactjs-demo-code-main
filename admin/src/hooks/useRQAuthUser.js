...
const useGenrateRefreshToken = (onSuccess, onError = onDefaultError) => {
  return useMutation('genrate-refresh-token', AdminAuthService.genrateRefreshToken, {
    onSuccess,
    onError,
  });
};
